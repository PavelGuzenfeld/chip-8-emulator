...
namespace chip8
{
    ...
    void Instructionset::delay()
    {
        if (m_bus.m_registers.m_delayTimer > 0)
        {

            std::this_thread::sleep_for(std::chrono::milliseconds(REFRESH_RATE_MS));
            --m_bus.m_registers.m_delayTimer;
        }
    }
    ...
    void Instructionset::beep()
    {
        if (m_bus.m_registers.m_soundTimer > 0)
        {
#ifdef _WIN32
...
#endif
            --m_bus.m_registers.m_soundTimer;
        }
    }
    ...
    void Instructionset::runOpcode(U16Bit a_opCode)
    {
